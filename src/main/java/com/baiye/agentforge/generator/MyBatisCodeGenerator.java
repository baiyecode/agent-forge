package com.baiye.agentforge.generator;
...
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.baiye.agentforge.genresult");
        ...
        globalConfig.getJavadocConfig()
                .setAuthor("<a href=\"https://github.com/baiyecode\">白夜</a>")
                .setSince("");
        return globalConfig;
    }
}
