package com.baiye.agentforgeuser.controller;
...
import com.baiye.agentforge.model.dto.user.*;
...
public class UserController {
     ...
     * @return 注册结果
     * @RequestBody 的作用是将 HTTP 请求体中的 JSON 字符串反序列化为 UserRegisterRequest 对象。
     */
