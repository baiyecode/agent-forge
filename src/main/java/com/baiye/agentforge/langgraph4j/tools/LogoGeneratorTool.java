 ...
 * <a href="https://bailian.console.aliyun.com/cn-beijing?type=model&tab=api#/api/?type=model&url=2862677">...</a>
 *
 * @Author 白夜
 * @Create 2026/5/25 19:32
 * @Version 1.0
 */
@Slf4j
@Component
    ...
    public List<ImageResource> generateLogos(@P("Logo 设计描述，如名称、行业、风格等，尽量详细") String description) {
        ...
        try {
            ...
            ImageSynthesisParam param = ImageSynthesisParam.builder()
                    ...
                    .build();
            //创建 ImageSynthesis 执行器并调用 API，返回结果对象。
